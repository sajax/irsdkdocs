import{_ as i,r as t,o,c as l,a as e,b as r,d as a,e as c}from"./app-DuzLYwnF.js";const d={},h={id:"carleftright",tabindex:"-1"},u={class:"header-anchor",href:"#carleftright"},m={class:"custom-container tip"},_=c(`<p class="custom-container-title">Developer Post</p><p>I&#39;m adding in a new telemetry variable called &quot;CarLeftRight&quot; that tracks the spotters current thoughts on car low/high status. It outputs the following enum:</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>enum irsdk_CarLeftRight
{
irsdk_LROff,
